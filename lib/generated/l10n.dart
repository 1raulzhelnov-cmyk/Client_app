...
class S {
  ...
  String get cancellationReasonChangedMind =>
      _t('cancellationReasonChangedMind');
  String get cancellationReasonWrongAddress =>
      _t('cancellationReasonWrongAddress');
...
const Map<String, String> _ruValues = <String, String>{
  ...
  'deliveryFeeLabel': 'Доставка',
    ...
    'cancellationReasonChangedMind': 'Передумал(а)',
    'cancellationReasonWrongAddress': 'Неверно указан адрес',
    'confirmCancellation': 'Подтвердить отмену',
    'refundInfo': 'Возврат в течение 24 часов, если заказ ещё не в пути.',
...
const Map<String, String> _enValues = <String, String>{
  ...
  'selectPaymentMethod': 'Select a payment method.',
    ...
    'cancellationReasonChangedMind': 'Changed my mind',
    'cancellationReasonWrongAddress': 'Wrong address',
    'confirmCancellation': 'Confirm cancellation',
    'refundInfo': 'Refund in 24h if not in transit.',
